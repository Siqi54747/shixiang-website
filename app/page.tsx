...
export default function Home() {
  ...
  return (
    <>
      <section className="px-6 md:px-24 pt-14 md:pt-20 pb-14 md:pb-20">
        ...
        <div className="mt-12 md:mt-14 flex flex-col md:flex-row md:items-center gap-3 md:gap-8">
          {featured ? (
            <Link
              href={`/reports/${featured.slug}`}
              className="inline-block border-b border-crimson pb-[6px] text-[14px] text-ink hover:text-crimson transition-colors w-fit whitespace-pre"
            >
              {copy.hero.cta}
            </Link>
          ) : (
